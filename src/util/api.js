...
export const updateUserFirstBooking = body => {
  return post('/api/update-first-booking', body);
}

export const cancelByCustomerPrivileged = body => post('/api/cancel-by-customer-privileged', body);
