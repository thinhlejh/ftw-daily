...
const INTEGRATION_ID = process.env.SHARETRIBE_INTEGRATION_SDK_CLIENT_ID;
const INTEGRATION_SECRET = process.env.SHARETRIBE_INTEGRATION_SDK_CLIENT_SECRET;
...
exports.getIntegrationSdk = () => sharetribeIntegrationSdk.createInstance({
  clientId: INTEGRATION_ID,
  clientSecret: INTEGRATION_SECRET,
});
